 ...
 */
public class GetBusinessMeetsRequest implements KvmSerializable{
    private static final String headerTag = "n0:header";
    private static final String conferenceIdTag = "n0:conferenceId";
    ...
    public GetBusinessMeetsRequest(HeaderType header, Integer confId) {
        setHeader(header);
        setConfId(confId);
    }
