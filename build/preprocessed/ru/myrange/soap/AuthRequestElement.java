/*
This class represetns the authRequestElement element from myrange.wsdl

<xs:element name="authRequestElement">
    <xs:complexType>
        <xs:all>
...
public class AuthRequestElement implements KvmSerializable {
	...
	public AuthRequestElement(HeaderType header) {
		setHeader(header);
	}
