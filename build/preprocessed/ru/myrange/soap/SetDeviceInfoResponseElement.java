...
/*
<xs:element name="setDeviceInfoResponseElement">
    <xs:complexType>
        <xs:all>
...
/**
 * This class represetns the setDeviceInfoResponseElement type from myrange.wsdl
 *
 * @author Oleg Ponfilenok
 */
public class SetDeviceInfoResponseElement implements KvmSerializable {
	...
	public SetDeviceInfoResponseElement() { }

    public SetDeviceInfoResponseElement(SoapObject soapObj) throws Exception {	// Create new class from SoapObject
