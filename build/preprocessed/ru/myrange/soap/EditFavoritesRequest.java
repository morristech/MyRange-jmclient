...
/*
<xs:element name="editFavoritesRequest">
    <xs:complexType>
        <xs:sequence>
...
/**
 * This class represetns the editFavoritesRequest element from myrange.wsdl
 * @author Oleg Ponfilenok
 */
public class EditFavoritesRequest implements KvmSerializable {
    ...
    public EditFavoritesRequest(HeaderType header, Vector userIdToAdd, Vector userIdToRemove) {
        setHeader(header);
