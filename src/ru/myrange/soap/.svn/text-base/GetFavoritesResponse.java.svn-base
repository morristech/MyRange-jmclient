...
/**
 * This class represetns the getFavoritesResponse element from myrange.wsdl
 * @author Oleg Ponfilenok
 */
public class GetFavoritesResponse implements KvmSerializable {
    ...
    public GetFavoritesResponse(SoapObject soapObj) throws Exception {	// Create new class from SoapObject
