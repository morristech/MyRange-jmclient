/*
This class represetns the authResponseElement type from myrange.wsdl

<xs:element name="authResponseElement">
    <xs:complexType>
        <xs:all>
...
public class AuthResponseElement implements KvmSerializable {
	...
	public AuthResponseElement() { }

    public AuthResponseElement(SoapObject soapObj) throws Exception {	// Create new class from SoapObject
