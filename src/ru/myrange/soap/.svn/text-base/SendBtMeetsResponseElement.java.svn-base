/*
This class represetns the sendBtMeetsResponseElement type from myrange.wsdl

<xs:element name="sendBtMeetsResponseElement">
    <xs:complexType>
        <xs:all>
...
public class SendBtMeetsResponseElement implements KvmSerializable {
	...
	public SendBtMeetsResponseElement() { }

    public SendBtMeetsResponseElement(SoapObject soapObj) throws Exception {	// Create new class from SoapObject
