...
/*
<xs:element name="getFavoritesRequest">
    <xs:complexType>
        <xs:sequence>
...
/**
 * This class represetns the getFavoritesRequest element from myrange.wsdl
 * @author Oleg Ponfilenok
 */
public class GetFavoritesRequest implements KvmSerializable {
    ...
    public GetFavoritesRequest(HeaderType header) {
        setHeader(header);
    }
