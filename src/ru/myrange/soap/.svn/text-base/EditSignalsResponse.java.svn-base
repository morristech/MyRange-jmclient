...
/*
<xs:element name="editSignalsResponse">
    <xs:complexType>
        <xs:sequence>
...
/**
 * This class represetns the editSignalsResponse type from myrange.wsdl
 * @author Oleg Ponfilenok
 */
public class EditSignalsResponse implements KvmSerializable {
    ...
    public EditSignalsResponse(SoapObject soapObj) throws Exception {
